...
import 'package:flutter_urshelf/data/database.dart';
...
class Repository {
  ...
  Future<ParsedResponse<List<Book>>> getBooks(String input) async {
    ...
    http.Response response = await http.get(url).catchError((resp) {});
    ...
    return ParsedResponse(response.statusCode, []..addAll(networkBooks.values));
  }
