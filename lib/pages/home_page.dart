...
import 'package:flutter_urshelf/widgets/collection_preview.dart';
...
import 'package:flutter_urshelf/utils/index_offset_curve.dart';
import 'package:flutter_urshelf/widgets/collection_preview.dart';
...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  Widget wrapInAnimation(Widget child, int index) {
    Animation offsetAnimation = CurvedAnimation(parent: cardsFirstOpenController, curve: IndexOffsetCurve(index));
    Animation fade = CurvedAnimation(parent: offsetAnimation, curve: Curves.ease);
